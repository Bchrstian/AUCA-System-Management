  ...
  <body>
    <header class="main-header">
      <div class="top-bar">
        <div class="row">
          <nav>
            <a href="#">Apply</a><a href="#">Online Registration</a
            ><a href="#">e-Library</a><a href="#">Newsletter</a>
          </nav>
      ...
      <div class="main-nav-bar">
        <nav>
          ...
          ><a href="media.jsp">Media Center</a
          ><a href="research.jsp">Research</a><a href="apply.jsp">Apply</a
          ><a id="loginBtn" href="login.jsp">Login</a
