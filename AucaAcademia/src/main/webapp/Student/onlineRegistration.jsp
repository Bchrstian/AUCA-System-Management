...
<html lang="en">
  ...
  <body>
          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-content">
                ...
                <li>
                  <a href="sundergraduate.jsp" onclick="academic.jsp"
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-content">
               <li><a href="media.jsp" onclick="mediacenter.jsp">Service Charter</a></li>
                <li>
    ...
    >
      ...
      <br>
      <a href="studashboard.jsp" style="color: rgb(5, 59, 121)"><b>Click Here to Connect to AUCA Online Registration Software</b></a>
      <br><br>
   <a href="studashboard.jsp" style="color: rgb(5, 59, 121) "><b>If you are outside of AUCA Click <u>here</u></b></a>
