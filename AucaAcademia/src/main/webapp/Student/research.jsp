    ...
    >
      ...
      >
        ...
        <div class="content-block">
              ...
              ></div>
              <br>
              <p style="color: rgba(10, 76, 152, 0.733); font-size: medium; "><span style="text-decoration: underline;">Volume 2,</span><span style="text-decoration: underline;">Issue 2,</span><span style="text-decoration: underline;">2021,</span><span style="text-decoration: underline;">Download</span></p>
              <br>
              <p style="color: rgba(10, 76, 152, 0.733); font-size: medium;"><span style="text-decoration: underline;">Volume 3,</span><span style="text-decoration: underline;"></span>Issue 1,<span style="text-decoration: underline;">2022</span></p>
              <br>
              <p style="color: rgba(10, 76, 152, 0.733); font-size: medium;"><span style="text-decoration: underline;">Volume 3,</span><span style="text-decoration: underline;">Issue 2,</span><span style="text-decoration: underline;">2022</span></p>
              <br>
              <p style="color: rgba(10, 76, 152, 0.733); font-size: medium;"><span style="text-decoration: underline;">AUCA JIDA June 2023 Vol 4 (1)</span></p> <button>Download</button>
              <br>
              <p style="color: rgba(10, 76, 152, 0.733); font-size: medium;"><span style="text-decoration: underline;">AUCA JIDA December 2023 Volume 4, Issue (2)</span></p> <button>New</button>
              <br>
