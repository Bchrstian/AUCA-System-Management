      ...
      >
        <div class="wrapper">
          <div class="column column-wide">
           ...
           <div class="post-content" style="font-size: 16px; font-family: Arial; color: #000000">
                <br>
                <h1
                class="post-title"
                style="font-size: 24px; color: #000000; margin-bottom: 20px"
              >
              The Rationale of the Department</h1>
              <p style="font-weight: normal ">Software Engineering is a field that is more concerned with:  The design, development, testing, and maintenance of software applications. This department teaches our students how to apply engineering principals and knowledge of programming languages to build software solution for end users.</p>
                <br>
                <h1
                class="post-title"
                style="font-size: 24px; color: #000000; margin-bottom: 20px"
              >
              The Competencies and Exit Profile</h1>
              <p style="font-weight: normal"> <strong>Behaviors and Attitude:</strong> The behavior and attitude of student in Software Engineering department come from the AUCA belief and values they learned during their learning period, through integration of faith in learning. The belief and values are :</p>
              <br>
              ...
              Knowledge</h1>
              <ul style="font-weight: normal">
                <li>Know how to write and Speak English language</li>
                <li>Know how to design and maintain software systems</li>
                <li>Know how to evaluate and test new software programs</li>
                <li>Know how to optimize software for speed and scalability</li>
                <li>Understand how to write and test code</li>
                <li>Know how to consult with clients, engineers, security specialist, and other stakeholders</li>
                <li>Know how to present new features to stakeholders and internal customers</li>
              </ul>
              <br>
                <h1
                class="post-title"
              ...
              Skills</h1>
              <ul style="font-weight: normal">
                <li>Research business problems</li>
                <li>Decide on the expected business value</li>
                <li>Draft nonfunctional requirements</li>
                <li>Prepare functional requirements</li>
                <li>Formulate the main backlog</li>
                <li>Deliverable: <strong>Documented Business Requirements</strong></li>
              </ul>
                <br>
                <h1
                class="post-title"
                style="font-size: 24px; color: #000000; margin-bottom: 20px"
              >
              In Software Development Phase, they have the ability to :</h1>
              <ul style="font-weight: normal">
                <li>Setup preparation activities</li>
                <li>Track development process</li>
                <li>Deliverable: <strong>A released business software product</strong></li>
              </ul>
                <br>
                <h1
                class="post-title"
                style="font-size: 24px; color: #000000; margin-bottom: 20px"
              >
              In Software Maintenance Phase, they have the ability to :</h1>
              <ul style="font-weight: normal">
                <li>Gather and process feedback from customer and users</li>
                <li>Formulate the next backlog</li>
                <li>Deliverable: <strong>A maintained and improved business software product</strong></li>
              </ul>
                <br>
