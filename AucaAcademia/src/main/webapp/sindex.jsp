      ...
      <div class="top-bar">
        <div class="row">
          <nav class="custom-nav">
            ...
            <a href="#">e-Library</a>
            <a href="#">Newsletter</a>
            <a href="studashboard.jsp" >Dashboard</a>
      ...
      <div class="main-nav-bar">
        <nav>
          <ul>
            ...
            <li class="dropdown">
              <a href="academics.jsp" onclick="showContent('academics')">Academics</a>
              <ul class="dropdown-content">
                <li>
            ...
            <li><a href="#" onclick="showContent('apply')">Apply</a></li>
             <li><a href="index.jsp" onclick="showContent('login Out')">Log out</a></li>
          </ul>
        </nav>
